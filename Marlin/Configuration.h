...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {78.7402,78.7402,200*8/3,760*1.1}  // default steps per unit for ultimakerhave to make changes here 
#define DEFAULT_MAX_FEEDRATE          {500, 500, 5, 25}    // (mm/sec)    
#define DEFAULT_MAX_ACCELERATION      {9000,9000,100,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.

#define DEFAULT_ACCELERATION          3000    // X, Y, Z and E max acceleration in mm/s^2 for printing moves 
#define DEFAULT_RETRACT_ACCELERATION  3000   // X, Y, Z and E max acceleration in mm/s^2 for r retracts
//changes in setting if required
//i have to just uncomment the below part for stepper changes
#define DEFAULT_AXIS_STEPS_PER_UNIT {78.7402,78.7402,200*8/3,760*1.1}

//With:cool i have made all the changes just have to uncomment the below lines of code when required.
/*#define MM_PER_INCH 25.39997
#define STEPS_PER_REVOLUTION_X 3200
#define STEPS_PER_REVOLUTION_Z 1600
